...
**Project Title:** CareerGraph — Agent-Based Labor Market Intelligence Platform for Student Career Guidance
...
Furthermore, existing tools rarely explain *why* a particular recommendation was made, reducing student trust and engagement. What is needed is a system that combines real labor market data, graph-based skill modeling, and explainable reasoning to provide students with personalized, transparent, and actionable career intelligence.
...
5. A demonstrated alignment between student skill profiles and real labor market demand, validated through end-to-end user journey testing across the platform's core flows: registration, skill gap analysis, roadmap generation, and job recommendation.
